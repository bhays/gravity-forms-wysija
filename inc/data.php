...
class GFWysijaData{
    ...
    public static function update_table(){
        global $wpdb;
        $table_name = self::get_wysija_table_name();
    ...
    public static function get_wysija_table_name(){
        global $wpdb;
        return $wpdb->prefix . "rg_wysija";
    }
    ...
    public static function drop_tables(){
        global $wpdb;
        $wpdb->query("DROP TABLE IF EXISTS " . self::get_wysija_table_name());
    }
}
?>
